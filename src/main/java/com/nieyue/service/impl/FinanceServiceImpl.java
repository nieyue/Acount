...
public class FinanceServiceImpl implements FinanceService{
	...
	@Override
	public int countAll() {
		int c = financeDao.countAll();
		return c;
	}

	@Override
	public List<Finance> browsePagingFinance(int pageNum, int pageSize,
		...
		List<Finance> l = financeDao.browsePagingFinance(pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
