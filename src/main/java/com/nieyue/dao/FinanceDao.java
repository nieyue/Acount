...
public interface FinanceDao {
	...
	public int countAll();	
	/** 分页财务信息 */
	public List<Finance> browsePagingFinance(@Param("pageNum")int pageNum,@Param("pageSize")int pageSize,@Param("orderName")String orderName,@Param("orderWay")String orderWay) ;		
}
